...
export function DetalhesChamado() {
    ...
    // Carrega os dados do chamado e a lista de técnicos
    const loadDados = async () => {
        try {
            ...
            // Carrega técnicos apenas se for necessário (para o dropdown)
            const techResponse = await api.get('/api/tecnicos');
